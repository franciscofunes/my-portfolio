								...
								>
									<div className='desc'>
										<div className='con'>
											...
											<span>
												Website para Consultora en seguridad e higiene, Grupo
												Dehl
											</span>
											<p className='icon'>
												<span>
													<a href='https://www.linkedin.com/sharing/share-offsite/?url=https://www.grupodehl.com'>
														<i
								...
								>
									<div className='desc'>
										<div className='con'>
											...
											<span>Website para Local comercial, Farmacia La Paz</span>
											<p className='icon'>
												<span>
													<a
														href='https://www.linkedin.com/sharing/share-offsite/?url=https://www.farmacialapaz.com.ar'
														target='_blank'
														rel='noopener noreferrer'
													>
												...
												<span>
													<a
														href='https://www.farmacialapaz.com.ar'
														target='_blank'
														rel='noopener noreferrer'
													>
														<i className='icon-eye' /> 100
									...
									<div className='desc'>
										<div className='con'>
											...
											<p className='icon'>
												<span>
													<a
														href='https://www.linkedin.com/sharing/share-offsite/?url=https://codepen.io/FranFunes/pen/vYOzdNX'
														target='_blank'
														rel='noopener noreferrer'
													>
														<i className='icon-share3' />
												...
												<span>
													<a
														href='https://codepen.io/FranFunes/live/vYOzdNX'
														target='_blank'
														rel='noopener noreferrer'
													>
														<i className='icon-eye' /> 100
								...
								>
									<div className='desc'>
										<div className='con'>
											...
											<span>
												Website a manera de maqueta para consultora de
												soluciones ERP
											</span>
											<p className='icon'>
												<span>
													<a
														href='https://www.linkedin.com/sharing/share-offsite/?url=https://freesolutionserp.web.app/'
														target='_blank'
														rel='noopener noreferrer'
													>
														<i className='icon-share3' />
												...
												<span>
													<a
														href='https://freesolutionserp.web.app/'
														target='_blank'
														rel='noopener noreferrer'
													>
														<i className='icon-eye' /> 100
						...
						<div className='row'>
							<div className='col-md-12 animate-box'>
								<p>
									...
									>
										Más proyectos <i className='icon-reload' />
									</a>
								</p>
							</div>
						</div>
